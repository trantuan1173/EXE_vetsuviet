...
const Footer = () => {
  return (
    <footer id="about" className="bg-[#6F0D0D] text-white px-6 py-16 mt-0">
      <div className="mx-auto max-w-[1280px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          <Link to="/" className="flex items-center gap-3 mb-5">
            <img src={logoIcon} alt="Vết Sử Việt Logo" className="h-10 w-auto" />
            <img src={logoText} alt="Vết Sử Việt" className="h-7 w-auto" />
          </Link>
        ...
        <div>
          <h4 className="text-[#D4AF37] text-xl font-bold mb-5">Khóa học</h4>
        ...
        <div>
          <h4 className="text-[#D4AF37] text-xl font-bold mb-5">Hỗ trợ</h4>
          <ul className="space-y-3 text-white/70">
            <li>
              <Link to="/courses" className="hover:text-white transition-colors">
                Hướng dẫn sử dụng
        ...
        <div>
          <h4 className="text-[#D4AF37] text-xl font-bold mb-5">Liên hệ</h4>
          <ul className="space-y-3 text-white/70">
            <li>
      ...
      <div className="mx-auto max-w-[1280px] mt-12 pt-8 border-t border-white/20 text-center text-white/50 text-sm">
